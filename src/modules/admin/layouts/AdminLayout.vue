...
<!-- Component Start -->
        ...
        <div class="flex flex-col w-56 border-r border-gray-300">
            ...
            <div class="flex flex-col flex-grow p-4 overflow-auto">
                <RouterLink to="/admin" class="flex items-center flex-shrink-0 h-10 px-2 text-sm font-medium rounded hover:bg-gray-300" href="#">
                    <span class="leading-none">Dashboard</span>
                </RouterLink>
                <RouterLink to="/admin/products" class="flex items-center flex-shrink-0 h-10 px-2 text-sm font-medium rounded hover:bg-gray-300" href="#">
